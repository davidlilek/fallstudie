...
VlnPlot(pbmc, features = c("CD3D", "CD4", "CD8A", "NCAM1", "CD19", "CD14", "FCGR3A", "CD1C", "LILRA4"))
```

* Feature plot

```{r fig.height=20, fig.width=15}
FeaturePlot(pbmc, features = c("CD3D", "CD4", "CD8A", "NCAM1", "CD19", "CD14", "FCGR3A", "CD1C", "LILRA4"))
FeaturePlot(pbmc, features = c("CD3D", "CD4", "CD8A", "NCAM1", "CD19", "CD14", "FCGR3A", "CD1C", "LILRA4"), reduction = "tsne")
```
...
DimPlot(pbmc, reduction = "tsne", label = TRUE, pt.size = 0.5, repel = TRUE, label.box = TRUE) + NoLegend()
```