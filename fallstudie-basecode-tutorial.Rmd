...
But as stated in the tutorial, other things also have to be taken into account and a comparison of downstream analysis results using different number of PCs should be performed. They also recommend to "err on the higher side" for the number of PCs is chosen.
